...
**Command** *(Virtual Class)* **-**  In our code we translate every line of the text file (fly.txt) to a command. this virtual class is an interface for every command in the 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDQ5OTM2NDIsMjI0ODQxOTk1XX0=
-->