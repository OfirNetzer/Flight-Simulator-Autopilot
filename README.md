...
**DefineVarCommand** **-** (inherit from "Command" Class) a Class that determines what kind of variable we are facing (new Var, e 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0ODc0MDY3NSwtNjU0MzY2MDZdfQ==
-->