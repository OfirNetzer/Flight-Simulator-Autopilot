...
```mermaid
graph LR
A[Square Rect] -- stam --> B((Circle))
A --> C(Round Rect)
B --> D{Rhombus}
C --> D
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NzgzNzI0MF19
-->